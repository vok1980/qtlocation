...
#ifndef QGEOPOSITIONINFOSOURCE_ANDROID_GMS_P_H
#define QGEOPOSITIONINFOSOURCE_ANDROID_GMS_P_H
...
public:
    ...
    ~QGeoPositionInfoSourceAndroidGms();
...
#endif // QGEOPOSITIONINFOSOURCE_ANDROID_GMS_P_H
